<!-- Generated by init scan. Scanned sections are bootstrap content (confidence: observed).
     Template sections (SESSION START, CODING DISCIPLINE, POST-TASK CHECKLIST, SELF-EVOLUTION RULES) are canonical from day one. -->

# {{PROJECT_NAME}}

<!-- bootstrap: verify and promote to canonical -->
## IDENTITY
...
Key architectural decisions and their rationale should be recorded in `.agents/knowledge/decisions/` as they are discovered.
...
For the complete file inventory, see `.agents/knowledge/reference/code-map.md`.
...
For the full routing table, see `.agents/knowledge/reference/code-map.md`.

<!-- bootstrap: verify and promote to canonical -->
## CORE INVARIANTS

Project-wide rules. Each entry is a summary — authoritative details live in the linked domain file.
...
Sections marked with `<!-- bootstrap: verify and promote to canonical -->` were generated by scanning. They are confidence: observed and should be verified against current code.

Template sections (SESSION START, CODING DISCIPLINE, POST-TASK CHECKLIST, SELF-EVOLUTION RULES) are canonical from day one — they define the knowledge governance protocol, not project facts.

If a scanned claim conflicts with code, trust the code and capture the conflict in `.agents/knowledge/inbox/`.
